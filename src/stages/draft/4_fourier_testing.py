...
source_directory = './src/stages/augmented_data'
...
output_csv = './src/stages/fourier_pca_output.csv'
df = pd.DataFrame(severity_level_information, columns=cols)
df.to_csv(output_csv, index=False)
print(f"Features saved to {output_csv}")

# Save the PCA Model
joblib.dump(pca, './src/stages/draft/4_fourier_pca_model.pkl')
print("Final model saved as 4_fourier_pca_model.pkl")