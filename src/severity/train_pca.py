...
# Constants
PCA_CSV_PATH = './src/severity/pca_output.csv'
...
def main():
    ...
    best_model.save('PCA_mpox_severity_final_model.keras')
    print("Final model saved as PCA_mpox_severity_final_model.keras")
